...
def test_tier3_sample_template_is_deterministic_and_contract_compliant():
    out1 = run_guardians(repo_path=".", guardians=["sample_guardian:v1"])
    out2 = run_guardians(repo_path=".", guardians=["sample_guardian:v1"])
